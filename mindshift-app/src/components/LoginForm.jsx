...
function LoginForm({ onTogglePage }) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            setAlertInfo({ message: 'Login successful!', type: 'success' });
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-slate-900">
      ...
      <form onSubmit = {handleSubmit} className="w-full max-w-md p-8 space-y-6 bg-slate-800 rounded-lg shadow-2xl">
        ...
        <input
          ...
          className="w-full px-4 py-2 text-white bg-slate-700 border border-slate-600 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500"
        />
        ...
        <button
          type="submit"
          className="w-full px-4 py-3 font-semibold text-white bg-cyan-600 rounded-md hover:bg-cyan-700 transition-colors"
        >
          Login
        </button>
